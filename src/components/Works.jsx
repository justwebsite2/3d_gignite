...
const ProjectCard = ({ index, name, description, tags, image, source_code_link }) => {
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <div className="bg-gray-900 p-5 rounded-2xl sm:w-[360px] w-full">
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card card-img_hover">
            <div
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} font-bold`}>Gignite</p>
        <h2 className={styles.sectionHeadText}>Project Benefits</h2>
      </motion.div>
...
export default SectionWrapper(Works, "details");