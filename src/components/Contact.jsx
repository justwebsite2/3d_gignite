  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div
        ...
        className="flex-[0.75] bg-gray-300 p-8 rounded-2xl"
      >
        ...
        >
          <label className="flex flex-col">
            ...
            <input 
              ...
              placeholder ="Name"
              className="bg-gray-400 py-4 px-6 placeholder:text-gray-600 text-white rounded-lg outlined-none border-none font-medium"
            />
          </label>
